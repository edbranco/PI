...
<html>
    ...
    <body>                  
        ...
        <div class="formulario">
            <form action="ServletPreVendaProduto" method="post" onsubmit="return validarVender();">  
                <fieldset>
                    ...
                    <p class="ipt-curto ipt-curto-1">
                        ...
                        <input class="form-control" type="number" step=0.01 name="precoProduto" id="precoproduto" value="${produto.preco}" readonly />
                    </p>
                    <p>
                        <label for="qtdeproduto">Quantidade:</label><br />
                        <input class="form-control" type="number" name="qtdeProduto" id="qtdeproduto" value="${produto.qtde}" readonly />
                    </p><br />
