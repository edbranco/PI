...
function carregar (evt) {        
    ...
    if (document.getElementById('semRegistro').value === "true") {
        document.getElementById("exc-alert-pro").classList.add("aparecer");
    } else {
        document.getElementById("exc-alert-pro").classList.add("desaparecer");        
    }
    
    //Mostra informações do cliente caso ele exista    
    if (document.getElementById('produtoExiste').value === "true") {
