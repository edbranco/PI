 ...
 * @author Lucas
 */
@WebServlet(name = "RelatorioFilialVenda", urlPatterns = {"/RelatorioFilialVenda"})
public class RelatorioFilialVenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RelatorioFilialVenda</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RelatorioFilialVenda at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher disp
                = request.getRequestDispatcher("ServletCarregarRelatorio");
